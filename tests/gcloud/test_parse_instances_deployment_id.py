...
def fixture_pyperclip_copy() -> Generator[MagicMock]:
    """Mock pyperclip.copy"""
    with patch("codename_snake.gcloud.parse_instances_deployment_id.pyperclip.copy") as mock:
        yield mock
...
def fixture_run_operation() -> Generator[MagicMock]:
    """Mock run_operation"""
    with patch("codename_snake.gcloud.parse_instances_deployment_id.run_operation") as mock:
        yield mock
...
def fixture_ws_advice() -> Generator[MagicMock]:
    """Mock ws_advice"""
    with patch("codename_snake.gcloud.parse_instances_deployment_id.ws_advice") as mock:
        yield mock
...
def fixture_formatting_ws_success() -> Generator[MagicMock]:
    """Mock ws_success"""
    with patch("codename_snake.gcloud.parse_instances_deployment_id.ws_success") as mock:
