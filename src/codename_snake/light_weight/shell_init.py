...
import click
from codename_snake.constants import SHELL_OPT, MODULE_NAME
from codename_snake.config_environment.util import get_local_file
...
@click.command(
    ...
    epilog="""
    usage: snake get-local-config-path\n
    OPTIONS:\n
            usage: snake get-local-config-path
    """,
)
