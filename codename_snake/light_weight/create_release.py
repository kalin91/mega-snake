...
from codename_snake.light_weight.release import Release, get_latest_release
from codename_snake.util.formatting import ws_info, ws_success
from codename_snake.util.util import get_validated_input, get_current_commit
from codename_snake.constants import RELEASE_TYPE_OPT
...
@click.command(
    ...
    epilog="""
    usage: snake createRelease <tag_suffix> <release_type> [release_notes] [release_branch]\n
    Args:\n
